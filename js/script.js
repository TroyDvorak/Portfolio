...
setupToggleButtons(
    ...
    'portfolio-challenges-btn',
    `I designed, developed, and deployed a custom portfolio website to showcase my projects and skills. This project was an excellent opportunity 
    to deepen my knowledge of JavaScript, HTML, and CSS. Additionally, I integrated my own GPT model into the site, allowing visitors to interact
    with AI, demonstrating my ability to leverage artificial intelligence in software development.`,
    `One of the biggest challenges I faced was getting JavaScript, HTML, and CSS to work together smoothly. Figuring out how they interact was key to
making everything function properly. Another challenge was making sure the site looked good on different screen sizes, which took some trial and 
error. Lastly, integrating ChatGPT into my website was a learning experience, as I had to figure out how to connect it and make it work for users.`
);
